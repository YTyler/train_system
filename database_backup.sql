...
COPY public.stops (train_id, city_id, id, "time") FROM stdin;
68	20	13	1200
\.
...
SELECT pg_catalog.setval('public.stops_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.trains_id_seq', 68, true);
